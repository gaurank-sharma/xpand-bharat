    ...
    <div className="min-h-screen bg-[#f4f5f7] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative">
        <div className="text-center mb-8">
          <img src="/logo.png" alt="Xpand Bharat" className="h-10 w-auto object-contain mx-auto mb-5" />
          <h1 className="text-[#0b1430] text-2xl font-semibold">Admin Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-[#ffffff] border border-[#d4d7dd] text-[#0b1430] placeholder-gray-600 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#f07920] transition-colors"
              />
            </div>
            <div>
              <label className="block text-gray-600 text-xs mb-1.5 font-medium">Password</label>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full bg-[#ffffff] border border-[#d4d7dd] text-[#0b1430] placeholder-gray-600 rounded-lg px-4 py-2.5 pr-10 text-sm focus:outline-none focus:border-[#f07920] transition-colors"
                />
            ...
            >
              {loading ? <div className="w-4 h-4 border-2 border-[#e6e8ec] border-t-white rounded-full animate-spin" /> : <LogIn size={16} />}
