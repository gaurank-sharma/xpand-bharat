  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="w-8 h-8 border-2 border-[#f07920] border-t-transparent rounded-full animate-spin" />
      </div>
    );
  }

  const statCards = [
    { icon: MessageSquare, label: 'Total Contacts',     value: stats?.totalContacts,     color: 'bg-[#f07920]/20', sub: `${stats?.newContacts || 0} new`, href: '/admin/contacts' },
    ...
    { icon: BookOpen,      label: 'Published Insights', value: stats?.publishedInsights, color: 'bg-purple-500/20', href: '/admin/insights' },
  ];
